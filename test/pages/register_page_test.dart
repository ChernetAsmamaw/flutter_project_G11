...
import 'package:job_application_portal/pages/login_or_register_page.dart';
import 'package:job_application_portal/pages/login_page.dart';
import 'package:job_application_portal/pages/register_page.dart';
  ...
  group('loginPage', () {
    ...
    testWidgets("Testing Textfields", (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(home: RegisterPage(onTap: () => "Registered")),
      );
      // await tester.pump();
    ...
    testWidgets("Testing Icons", (WidgetTester tester) async {
      ...
      // await tester.pump();
      expect(find.byKey(const ValueKey("bb")), findsAtLeast(1));
    });
